...
# ---------------------------------------------------------------- กล้อง
CAMERA_INDEX = 0
# 640x480 ไม่ใช่ค่าที่สวยที่สุด แต่ MediaPipe บน CPU ทำ 1280x720 ได้แค่ ~7 FPS
# ซึ่งกระตุกจนเก็บข้อมูลและแปลสดไม่ไหว ความละเอียดเท่านี้พอสำหรับตรวจจับมือแล้ว
FRAME_WIDTH = 640
FRAME_HEIGHT = 480
